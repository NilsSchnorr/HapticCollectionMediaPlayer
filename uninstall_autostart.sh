...
echo "  python3 nfc_display.py    (backend, in one terminal)"
echo "  ./kiosk.sh                (fullscreen browser, in another)"
echo "Or windowed for development:"
echo "  ./start_display_simple.sh"
echo ""
